...
1. Fork the [Minimal Mistakes repo](http://github.com/superhealth/corening/fork).
...
1. [Download Minimal Mistakes](https://github.com/superhealth/corening/releases/tag/2.2.1) and unzip.
...
```yaml
url: http://superhealth.github.io/corening
...
To assign Corening as an author for our post. We'd add the following YAML front matter to a post:
